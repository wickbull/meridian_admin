...
{!! inject_tpl([
        ...
        'LecturersFormBase',
        'AnnoncesCategoryFormBase',
        'TagsFormBase',
        'LaboratoriesFormBase',
        'StatusesFormBase',
        'ChairsFormBase',
        'StoragableFormBase'
    ], isset($annonce) ? $annonces : "Packages\Annonce") !!}


<div class="form-group">

    {!! Form::label('event_at', _('Event time'), ['class' => 'control-label']) !!}

    <div class="input-group w-md">

        {!! Form::input('text', 'event_at', isset($annonces) ? $annonces->event_at->format('d.m.Y H:i') : \Carbon\Carbon::now()->format('d.m.Y H:i'), ['class' => 'form-control w-md js-datepicker js-publish-time', 'data-require' => 'datepicker', 'data-timepick' => 'true', 'data-drops' => 'up', 'data-format' => 'DD.MM.YYYY HH:mm' , 'required' => 'required']) !!}
...
{!! inject_tpl(['AnnoncesCheckBoxes'], isset($annonces) ? $annonces : "Packages\Annonce") !!}
