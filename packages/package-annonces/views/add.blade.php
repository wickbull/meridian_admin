...
@section('title') {{_('Annonce add')}} @endsection
                ...
                <div class="bg-light lter b-b wrapper-md">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">{{ _('Add annonce') }}</small>
                        </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        {!! Form::open(['class' => 'js-primary-form']) !!}
                                            ...
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="next_action" value="save">{{_('Create annonce')}}</button>
