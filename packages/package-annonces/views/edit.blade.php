            ...
            <div class="vbox">
                ...
                <div class="bg-light lter b-b wrapper-md">
                    ...
                    <div class="pull-right padder">
                        {!! Form::open(['method' => 'DELETE', 'url' => action('\Packages\PackageAnnoncesController@deleteDelete', $annonces)]) !!}
                            <button class="btn btn-danger">{{ _('Delete annonce') }}</button>
                        {!! Form::close() !!}
                    </div>

                    <h1 class="m-n font-thin h3 text-black">{{ _('Annonces') }}</h1>
                    <small class="text-muted">{{ _('Edit annonce' )}}</small>
                </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="nav-tabs-alt m-b-xs">
                                            <ul class="nav nav-tabs js-right-sidebar-tabs" role="tablist">
                                                ...
                                                {{-- {!! inject_tpl(['GalleriableFormPrimaryTabsNav'], $annonces) !!} --}}
                                        ...
                                        {!! Form::model($annonces, ['class' => 'js-primary-form']) !!}

                                            <!-- Tabs -->
                                            <div class="tab-content m-t-md">
                                                <div class="tab-pane active" id="primary-form">
                                                    @include ('package-annonces::includes.form')
                                                </div>

                                                {{-- {!! inject_tpl(['GalleriableFormPrimaryTabsContant'], $annonces) !!} --}}
                                            ...
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="next_action" value="save">{{ _('Save annonce') }}</button>
